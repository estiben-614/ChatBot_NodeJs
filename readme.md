Hello, this NodeJS project   allows us to use the OPEN_AI API to access the CHAT GPT-3.5-Turbo feature. We are using the free version of the OPEN_AI API, which has a limit of 3 requests per minute.
